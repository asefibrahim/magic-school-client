        ...
        <div>
            ...
            <div class="flex flex-warp w-full">
                <div class="w-1/2 shadow-2xl">
                    <img class="hidden object-cover w-full h-screen md:block" src="https://images.pexels.com/photos/10111638/pexels-photo-10111638.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
                </div>
                ...
                <div class="flex flex-col  w-full md:w-1/2">
                    ...
                    <div class="flex flex-col justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
                        ...
                        <div class="pt-12 pb-12 text-white text-center">
                            <p>
